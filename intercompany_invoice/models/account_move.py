...
class SaleOrderLine(models.Model):
    ...
    def _purchase_service_create(self, quantity=False):
        ...
        for line in self:
            ...
            'sale', 'sale_purchase', 'sale_purchase_invoice_refund') and not line.order_id.auto_generated:
...
class purchase_order(models.Model):
    ...
    def button_approve(self, force=False):
        ...
        for order in self:
            ...
            if company_rec and company_rec.rule_type in ('sale', 'sale_purchase', 'sale_purchase_invoice_refund') and (not order.auto_generated):
