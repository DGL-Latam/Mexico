...
class Utilidades():
    ...
    def get_element(self, xpath : str) -> etree.Element:
        return self.element_root.find(xpath, self.internal_namespaces)

    def get_element_external(self, element : etree.Element, xpath : str) -> etree.Element:
        return element.find(xpath,self.external_namespaces)

    def set_element_text(self, xpath : str, text : str) -> None:
        element = self.element_root.find(xpath, self.internal_namespaces)
        element.text = text
